...
export function EventsSlideShow() {
  ...
  return (
    <div className="slide-container h-full bg-white">
      ...
      <br />
      <br />
      <h3 className="w-full my-2 text-3xl bg-white font-bold leading-tight text-center text-gray-800">
        Our Events
      </h3>
      <Fade>
        ...
        <div className="flex flex-col w-full p-6 rounded-lg shadow-md">
          ...
          <div className="flex-none p-6 mt-auto overflow-hidden bg-white">
            <div className="flex items-center justify-start">
              <button
                className="px-8 py-4 mx-auto my-6 font-bold text-white rounded-full shadow-lg lg:mx-0 hover:underline gradient focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
                onClick={handleClick}
              >
                Action
              </button>
